...
typedef enum {
    _LV_STYLE_STATE_CMP_SAME,/*2种状态下的样式属性是相同的*/
    _LV_STYLE_STATE_CMP_DIFF_REDRAW,/*可以通过简单的重画来显示差异*/
    _LV_STYLE_STATE_CMP_DIFF_DRAW_PAD,/*可以通过简单的重画来显示差异*/
    _LV_STYLE_STATE_CMP_DIFF_LAYOUT,/*可以通过简单的重画来显示差异*/
